...
namespace Lavy
{
    ...
    int dwExtraInfo);
        ...
        private void autoclickerThread_Tick(object sender, EventArgs e)
        {
            ...
            if (autoclickerStatus.Value == true && w.leftDown && (GetCaptionOfActiveWindow().Contains("Minecraft 1.7.10") || GetCaptionOfActiveWindow().Contains("Badlion Minecraft Client")))
            {
        ...
        private void wtapThreadPress_Tick(object sender, EventArgs e)
        {
            ...
            if (wtapStatus.Value == true && w.leftDown && IsKeyDown(Keys.W) && (GetCaptionOfActiveWindow().Contains("Minecraft 1.7.10") || GetCaptionOfActiveWindow().Contains("Badlion Minecraft Client")))
            {
        ...
        {
            if (wtapStatus.Value == true && w.leftDown && (GetCaptionOfActiveWindow().Contains("Minecraft 1.7.10") || GetCaptionOfActiveWindow().Contains("Badlion Minecraft Client")))
            {
